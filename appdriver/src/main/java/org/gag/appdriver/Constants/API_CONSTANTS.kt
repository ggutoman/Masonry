...
enum class API_CONSTANTS(val fsURL : String){
    ...
    /**ACCOUNTS**/
    URL_BASE_SERVER("http://192.165.29.99/Masonry/app/"),
//    URL_BASE_SERVER("http://192.168.100.22/Masonry/app/"),
    ...
    URL_GET_MEMBERS("accounts/member_list.php"),
    URL_GET_MEMBER_ADDRESS("accounts/address_info.php"),
    URL_GET_MEMBER_CONTACT("accounts/contact_info.php"),
    URL_GET_MEMBER_EMAIL("accounts/email_info.php"),
